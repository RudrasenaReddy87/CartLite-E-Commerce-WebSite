  ...
  return (
    <div className={`cart-modal-overlay ${animationClass}`} onClick={handleBackdropClick}>
      <div className="cart-modal-enhanced">
        {/* Header */}
        <div className="cart-modal-header-enhanced">
          <div className="cart-modal-title-enhanced">
          ...
          <button
            onClick={handleClose}
            className="cart-modal-close-enhanced"
          >
        ...
        {/* Progress Bar */}
        <div className="cart-modal-progress-enhanced">
          ...
          <div className="progress-steps-enhanced">
            {[1, 2, 3, 4, 5].map((step) => (
              <div
                key={step}
                className={`progress-step-enhanced ${step <= currentStep ? 'active' : ''} ${step < currentStep ? 'completed' : ''}`}
              >
                <span className="step-number-enhanced">{step}</span>
                <span className="step-label-enhanced">
                  {step === 1 && 'Cart'}
                  {step === 2 && 'Info'}
                  {step === 3 && 'Address'}
                  {step === 4 && 'Payment'}
        ...
        {/* Content */}
        <div className="cart-modal-content-enhanced">
          {currentStep === 1 && (
            <div className="cart-items-section-enhanced">
              {items.length === 0 ? (
                ...
                <>
                  <div className="cart-items-list-enhanced">
                    {items.map((item) => (
                  ...
                  <div className="cart-summary-enhanced">
                    ...
                    <div className="summary-row-enhanced total-enhanced">
                      <span>Total</span>
                      <span>${total.toFixed(2)}</span>
                    </div>
                  </div>
          ...
          {currentStep === 5 && (
            <div className="order-confirmation-enhanced">
              <div className="confirmation-icon-enhanced">
        ...
        {/* Footer */}
        <div className="cart-modal-footer-enhanced">
      ...
      <style jsx>{`
        ...
        .animate-out .cart-modal-enhanced {
        ...
        .cart-modal-title-enhanced h2 {
          margin: 0;
          font-size: 0.875rem;
        }

        .cart-modal-close-enhanced {
        ...
        .cart-modal-close-enhanced:hover {
          background: rgba(255, 255, 255, 0.3);
          transform: scale(1.1);
        }

        .cart-modal-progress-enhanced {
        ...
        .progress-step-enhanced.active .step-number-enhanced {
          background: #667eea;
          color: white;
        }

        .progress-step-enhanced.completed .step-number-enhanced {
          background: #10b981;
          color: white;
        }
        ...
        .progress-step-enhanced.active .step-label-enhanced {
          color: #667eea;
        }

        .cart-modal-content-enhanced {
          flex: 1;
          overflow-y: auto;
          padding: 0.5rem;
          min-height: 120px;
        ...
        .summary-row-enhanced.total-enhanced {
        ...
        .confirmation-icon-enhanced {
          margin-bottom: 0.25rem;
        }

        .cart-modal-footer-enhanced {
          padding: 0.5rem 0.75rem;
          border-top: 1px solid #e5e7eb;
          background: #f8fafc;
        }
...
export default CartModalEnhanced;
